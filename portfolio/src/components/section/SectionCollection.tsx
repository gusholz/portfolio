...
export default function SectionCollection() {
  ...
  return (
    <>
      <Section imageUrl={IconManager.stack} inverted={false}>
        <TextSection
          text={
            "Here goes my awesome text talking about how incredible I am at work"
          }
        />
      </Section>

      <Section imageUrl={IconManager.stack} inverted={true}>
        <StackDisplay
          imageArray={
            darkMode
              ? [
      ...
      <Section imageUrl={IconManager.design} inverted={false}>
        <StackDisplay
          imageArray={
            darkMode
              ? [
              ...
              : [IconManager.figmaIcon, IconManager.adobeIllustrator]
          }
        />
      </Section>
    </>
